...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/blackmoonth/nav',
  ...
  // 您的网站地址，有利于SEO
  homeUrl: 'https://nav.zhuan.de',

  // 网站标题
  title: 'zhuan导航 - 精选实用导航网站',

  // 网站描述
  description: 'zhuan导航 - 精选实用导航网站',
  ...
  footerContent: `
    ...
    <div>Copyright © 2018-2021 zhuan.de, All Rights Reserved</div>
  `,
